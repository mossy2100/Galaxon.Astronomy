...
public class TestJulianDates
{
    ...
    public void TestDateTimeToJulianDay()
    {
        ...
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 1721425.5);

        // Test current date.
        dt = new DateTime(2022, 6, 7, 0, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 2459737.5);

        // Test middle of range.
        dt = new DateTime(5000, 7, 2, 0, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 3547454.5);

        // Test end of range.
        dt = new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 5373483.5);

        // Test values from Meeus p62.
        dt = new DateTime(2000, 1, 1, 12, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 2451545.0);
        dt = new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 2451179.5);
        dt = new DateTime(1987, 1, 27, 0, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 2446822.5);
        dt = new DateTime(1987, 6, 19, 12, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 2446966.0);
        dt = new DateTime(1988, 1, 27, 0, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 2447187.5);
        dt = new DateTime(1988, 6, 19, 12, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 2447332.0);
        dt = new DateTime(1900, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 2415020.5);
        dt = new DateTime(1600, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 2305447.5);
        dt = new DateTime(1600, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc);
        Assert.AreEqual(JulianDateService.DateTime_to_JulianDate(dt), 2305812.5);
    }
    ...
    public void TestDateTimeFromJulianDay()
    {
        ...
        dt2 = JulianDateService.JulianDate_to_DateTime(1721425.5);
        Assert.AreEqual(dt1.Ticks, dt2.Ticks);

        dt1 = new DateTime(2022, 6, 7, 0, 0, 0, 0, DateTimeKind.Utc);
        dt2 = JulianDateService.JulianDate_to_DateTime(2459737.5);
        Assert.AreEqual(dt1.Ticks, dt2.Ticks);

        dt1 = new DateTime(5000, 7, 2, 0, 0, 0, 0, DateTimeKind.Utc);
        dt2 = JulianDateService.JulianDate_to_DateTime(3547454.5);
        Assert.AreEqual(dt1.Ticks, dt2.Ticks);

        dt1 = new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc);
        dt2 = JulianDateService.JulianDate_to_DateTime(5373483.5);
        Assert.AreEqual(dt1.Ticks, dt2.Ticks);
    }
}
